define([
    ...
    pointDraw.prototype = Object.create(DrawBase.prototype);
    ...
    pointDraw.prototype.startEdit = function (_handler,entity,options, callBack) {
        let self = this;
